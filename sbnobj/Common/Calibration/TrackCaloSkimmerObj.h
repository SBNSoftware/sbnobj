...
namespace sbn {
  ...
  struct TrackInfo {
    ...
    //mcs icarus algorithm, c2 function at range momentum
    float mcs_tailsatrange_IF3D, mcs_tailsatrange_IF2DI1, mcs_tailsatrange_IF2DI2, mcs_tailsatrange_IF2DC;
    float mcs_tailsatrange_II3D, mcs_tailsatrange_II2DI1, mcs_tailsatrange_II2DI2, mcs_tailsatrange_II2DC;
    ...
    std::vector<float> mcs_ptest_IF3D, mcs_c2function_IF3D, mcs_tailssize_IF3D;
    ...
    std::vector<float> mcs_ptest_IF2DI1, mcs_c2function_IF2DI1, mcs_tailssize_IF2DI1;
    ...
    std::vector<float> mcs_ptest_IF2DI2, mcs_c2function_IF2DI2, mcs_tailssize_IF2DI2;
    ...
    std::vector<float> mcs_ptest_IF2DC, mcs_c2function_IF2DC, mcs_tailssize_IF2DC;
    ...
    std::vector<float> mcs_ptest_II3D, mcs_c2function_II3D, mcs_tailssize_II3D;
    ...
    std::vector<float> mcs_ptest_II2DI1, mcs_c2function_II2DI1, mcs_tailssize_II2DI1;
    ...
    std::vector<float> mcs_ptest_II2DI2, mcs_c2function_II2DI2, mcs_tailssize_II2DI2;
    ...
    std::vector<float> mcs_ptest_II2DC, mcs_c2function_II2DC, mcs_tailssize_II2DC;
