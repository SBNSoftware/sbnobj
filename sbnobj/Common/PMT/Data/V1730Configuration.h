/**
 * @file   sbnobj/Common/PMT/Data/V1730Configuration.h
 * @brief  Information from the configuration of a V1730 PMT readout board.
 * @author Gianluca Petrillo (petrillo@slac.stanford.edu)
 * @date   February 18, 2021
 * @see    sbnobj/Common/PMT/Data/V1730Configuration.cxx
 */

#ifndef SBNOBJ_COMMON_PMT_DATA_V1730CONFIGURATION_H
#define SBNOBJ_COMMON_PMT_DATA_V1730CONFIGURATION_H
...
namespace sbn {
  ...
  std::ostream& operator<<
    (std::ostream& out, sbn::V1730Configuration const& config);
...
//------------------------------------------------------------------------------
inline unsigned int sbn::V1730Configuration::preTriggerTicks() const
  { return static_cast<unsigned int>((1.0f - postTriggerFrac) * bufferLength); }


//------------------------------------------------------------------------------
inline unsigned int sbn::V1730Configuration::postTriggerTicks() const
  { return static_cast<unsigned int>(postTriggerFrac * bufferLength); }


//------------------------------------------------------------------------------
inline float sbn::V1730Configuration::bufferTime() const
  { return ticks2us(bufferLength); }


//------------------------------------------------------------------------------
inline float sbn::V1730Configuration::preTriggerTime() const
  { return ticks2us(preTriggerTicks()); }


//------------------------------------------------------------------------------
inline float sbn::V1730Configuration::postTriggerTime() const
  { return ticks2us(postTriggerTicks()); }


//------------------------------------------------------------------------------
inline bool sbn::V1730Configuration::operator==
...
#endif // SBNOBJ_COMMON_PMT_DATA_V1730CONFIGURATION_H
